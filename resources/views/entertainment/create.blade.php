                    ...
                    <div class="row">
                        <div class="col-md-1">
                                <div class="my-fixed-item">
                                        <p><b><h4>Entretenimiento</h4></b></p>
                                        <p>Escriba el monto total de las últimas vacaciones dividido por 12, 
                                           para que le dé el promedio de dinero mensual que debe separar para ese gasto.
                                           <br>
                                           Escriba cuánto gasta mensualmente en salir a pasear, en comer en restaurantes y en otros entretenimientos.
                                        </p>                                           
                                    </div>
                        </div>
                        <div class="col-md-11">
